...
export default function FAQSection() {
  ...
  return (
    <section className="py-20 md:py-28 bg-white border-t border-slate-100" id="faq">
      {/* FAQ Structured Data */}
      <script
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between p-5 md:p-6 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 rounded-2xl"
        ...
        <div className="mt-12 text-center">
          ...
          <a
            href={waLink("Halo Andis Lab, saya ingin bertanya mengenai...")}
            target="_blank"
