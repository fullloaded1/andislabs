...
const stats = [
  ...
  {
    value: "Senin-Sabtu",
    label: "Dukungan Teknis (Jam Kerja)",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-0 lg:divide-x lg:divide-slate-200">
          {stats.map((s) => (
            ...
            >
              ...
              <div>
                <p className="text-3xl sm:text-4xl font-black text-slate-900 leading-none mb-1 whitespace-nowrap tracking-tight">{s.value}</p>
