          ...
          <div id="kontak">
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start gap-2.5">
                ...
                <a href="tel:+6282125523466" className="text-slate-400 hover:text-teal-400 transition-colors">
                  0821-2552-3466
                </a>
              </li>
              <li className="flex items-start gap-2.5">
                ...
                <a href="mailto:info@andislab.com" className="text-slate-400 hover:text-teal-400 transition-colors">
                  info@andislab.com
                </a>
              </li>
              <li className="flex items-start gap-2.5">
