          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
            ...
            <div className="p-8 md:p-10 flex flex-col">
              ...
              <div className="space-y-3">
                ...
                <a
                  href={`https://andislab.com/katalog/${product.slug}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2.5 w-full bg-slate-900 hover:bg-slate-800 text-white font-bold px-6 py-3.5 rounded-xl transition-colors shadow-md"
                >
